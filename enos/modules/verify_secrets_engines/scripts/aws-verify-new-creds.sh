...
"$binpath" write "${MOUNT}/config/root" access_key="${AWS_ACCESS_KEY_ID}" secret_key="${AWS_SECRET_ACCESS_KEY}" region="us-east-1,us-east-2,us-west-1,us-west-2" username_template="${USERNAME_TEMPLATE}"
echo "---------------------------------"
